...
from tempus.timemgmt.infra import app, MessageBus, CurrentUser
...
def get_projects(message_bus=MessageBus):
...
def create_project(project: ProjectNew, message_bus=MessageBus):
    return dict(
